// This variable keeps track of who's turn is
let activePlayer = 'X';
...
function placeXOrO(squareNumber) {
    ...
    //The .some() methos is used to check each element of selectedSquare array to
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if(activePlayer === 'O') {
            ...
            disableClick ();
            //This function waits 1 second before placing the image and anabling click
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animaateLineDrawing() {
        ...
        //This method draws draws everything we lain out above
        c.stroke();
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //This condition cancels our animation loop if reach the the end points.
...
//This function clears our canvas after our win sound is playing
function clear() {
